...
class Crr(models.Model):
    ...
    usuario_agente = models.ForeignKey(AgenteAutuador, on_delete=models.PROTECT, related_name='crrs')
    agente_autuador = models.CharField(max_length=10, blank=True, null=True,verbose_name='Agente autuador')
