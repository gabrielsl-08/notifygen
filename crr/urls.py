...
from .views import (CrrViewSet, TabelaArrendatarioViewSet, ArrendatarioViewSet, AitViewSet,
                    TabelaEnquadramentoViewSet, EnquadramentoViewSet)

router = DefaultRouter()
router.register(r'crr', CrrViewSet)
router.register(r'tabelaarrendatario', TabelaArrendatarioViewSet)
router.register(r'arrendatario', ArrendatarioViewSet)
